...
export default function About() {
  ...
  return (
    <>
    <Navbar logo="Testify"/>
    <div className=" p-10 min-h-screen bg-gradient-to-b bg-white text-white">
      <title>Testify | About</title>
      
      {/* Hero Section with Animation */}
      <div className="pt-16 px-4 md:px-8 lg:px-16 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between p-8 bg-white text-gray-900 rounded-lg shadow-2xl mb-12 overflow-hidden relative">
          <div className="md:w-1/2 z-10">
            ...
            <button className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-bold py-3 px-6 rounded-full transition-all duration-300 transform hover:scale-105">
              Learn More
            </button>
          </div>
        ...
        <div className="bg-white text-gray-900 rounded-lg shadow-xl p-8 mb-12 relative overflow-hidden">
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="md:w-3/5">
              <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-indigo-600">Why We Exist?</h2>
              <p className="text-gray-600 mb-6">
              ...
              <h3 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-indigo-600 mb-4">How We Achieve This</h3>
        ...
        <div className="bg-white text-gray-900 rounded-lg shadow-xl p-8 mb-12">
          <h2 className="text-4xl md:text-5xl font-bold mb-10 text-center bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-indigo-600">What Sets Us Apart</h2>
