    ...
    <>
      <div className="container relative flex flex-col justify-between h-full max-w-6xl px-5 mx-auto xl:px-0 mt-5">
        ...
        <p className="mb-12 text-lg text-gray-500 text-center sm:text-left">
          Welcome, {user.name}! View your assigned tests, track your progress, and improve your performance.
        </p>
              ...
              <Link to="/student/assigned-tests">
                <div className="relative h-full ml-0 sm:mr-5">
                  ...
                  <div className="relative h-full p-5 bg-white border-2 border-indigo-500 rounded-lg">
                    <h3 className="my-2 text-lg font-bold text-gray-800">Assigned Tests</h3>
                    <p className="mb-2 text-gray-600">View and take your scheduled tests.</p>
                  </div>
                </div>
              </Link>
            </div>
              ...
              <Link to="/student/performance">
                <div className="relative h-full ml-0 sm:mr-5">
                  ...
                  <div className="relative h-full p-5 bg-white border-2 border-purple-500 rounded-lg">
                    <h3 className="my-2 text-lg font-bold text-gray-800">Performance Overview</h3>
                    <p className="mb-2 text-gray-600">Check your test scores and analyze your progress.</p>
                  </div>
                </div>
              </Link>
            </div>
              ...
              <Link to="/student/feedback">
                <div className="relative h-full ml-0 sm:mr-5">
                  ...
                  <div className="relative h-full p-5 bg-white border-2 border-blue-400 rounded-lg">
                    <h3 className="my-2 text-lg font-bold text-gray-800">Feedback & Insights</h3>
                    <p className="mb-2 text-gray-600">Get feedback on your performance and improve your skills.</p>
                  </div>
                </div>
              </Link>
            </div>
              ...
              <Link to="/student/resources">
                <div className="relative h-full ml-0 sm:mr-5">
                  ...
                  <div className="relative h-full p-5 bg-white border-2 border-green-500 rounded-lg">
                    <h3 className="my-2 text-lg font-bold text-gray-800">Study Resources</h3>
                    <p className="mb-2 text-gray-600">Access study materials and test preparation resources.</p>
                  </div>
                </div>
              </Link>
            </div>
